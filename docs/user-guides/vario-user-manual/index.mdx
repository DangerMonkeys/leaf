...
- **SinkAlarm**: How much sink (fpm or m/s) before the sinkn alarm starts beeping.  Values closer to zero will result in an often-beeping sink alarm.  Typically 400~600 fpm (2~3 m/s) is a good starting point for most pilots.
...
- **Bluetooth**: Turn Bluetooth on for sharing Leaf data with certain smartphone apps.  You don't need to do anything on Leaf to pair, just turn it on, then select the Leaf device in the compatible phone app.
