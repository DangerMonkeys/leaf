...
- **Save IGC File**: Save an IGC track file when timer is running (and GPS has a fix)
...
Flight logs will save to SD Card. Be sure to turn on the “Save IGC File” setting inside the Log Menu.
