...
namespace constrained_enum_detail {
...
template <typename E,
          typename std::enable_if_t<
              std::is_enum_v<E> && constrained_enum_detail::has_policy<E>::value, int> = 0>
inline E& operator++(E& e) {
  return constrained_enum_detail::inc(e, typename enum_policy<E>::behavior{});
}
...
template <typename E,
          typename std::enable_if_t<
              std::is_enum_v<E> && constrained_enum_detail::has_policy<E>::value, int> = 0>
inline E& operator--(E& e) {
  return constrained_enum_detail::dec(e, typename enum_policy<E>::behavior{});
}
