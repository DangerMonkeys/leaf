...
namespace {
  ...
  void sendNavData(WebServer& target) {
    ...
    String json;
    json.reserve(256 + (includePoints ? static_cast<size_t>(navigator.totalWaypoints) * 96 : 0));
    json = "{\"loaded_file\":\"";
