...
leafLogUrl=()=>{if(!leafLogActivationUrl)return'';let u=new URL(leafLogActivationUrl);u.searchParams.set('returnTo',location.origin+location.pathname);return u.toString()};
